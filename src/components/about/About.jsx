    ...
    <section id="about" className="flex flex-row h-[25rem] mb-12 md:flex-row md:mx-px xxxs:h-auto xxxs:flex-col-reverse xxs:h-auto xxs:flex-col-reverse xs:h-auto xs:flex-col-reverse justify-between xxxs:mx-auto xxxs:pl-1 xxs:mx-auto xxs:pl-1 xs:mx-auto sm:mx-auto xs:pl-1 sm:justify-between sm:items-center">
      <div className="sm:w-2/3">
        ...
        <div className="flex justify-start">
          <a href="https://drive.google.com/file/d/1EZ_zZhqI3v09vAmdJys0G8I01wMjjFio/view?usp=share_link" rel="noreferrer" target="_blank">
      ...
      <div className="flex items-center">
        <img src="https://github.com/Sonickmumba/sonick-portifolio/assets/106140591/a4d8a384-2a00-46b8-a711-82b7216f4e8d" className="rounded-full w-64 h-64 xxxs:w-28 xxxs:h-28 xxs:w-28 xxs:h-28 xs:w-28 xs:h-28 sm:w-32 sm:h-32 md:w-44 md:h-44" alt="" />
      </div>
    </section>
  );
};
