...
const Socialmedia = () => {
  ...
  return (
    <div className="xxxs:hidden xxs:hidden xs:hidden sm:hidden md:block lg:block xl:block row-start-1 row-end-2 md:mr-[50px] col-start-5 col-end-6 xxxs:col-start-2 xxxs:col-end-6 xxs:col-start-2 xxs:col-end-6 xs:col-start-2 xs:col-end-6">
      <ul className="flex justify-around md:justify-between gap-x-6 md:gap-x-1">
        <li className="hover:transition-all duration-200 ease transform hover:scale-110 hover:bg-slate-600 hover:rounded-full p-3">
          <a
            href="https://github.com/Sonickmumba"
            target="_blank"
        ...
        <li className="hover:transition-all duration-200 ease transform hover:scale-110 hover:bg-slate-600 hover:rounded-full p-3">
          <a
            href="https://www.linkedin.com/in/sonickmumba"
            target="_blank"
            rel="noopener noreferrer"
          >
            <span className="text-3xl rounded-full text-white dark:text-white">
        ...
        <li className="hover:transition-all duration-200 ease transform hover:scale-110 hover:bg-slate-600 hover:rounded-full p-3">
          <a
            href="https://angel.co/u/sonick-mumba"
            target="_blank"
            rel="noopener noreferrer"
          >
            <span className="text-3xl rounded-full text-white dark:text-white">
